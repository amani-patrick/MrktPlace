  ...
  return (
    <div>
      ...
      <div className="mt-6 grid gap-4 sm:grid-cols-3">
        <PortalStatCard label="Total views" value="12,400" accent="blue" />
        <PortalStatCard label="Completed deals" value={34} accent="green" />
        <PortalStatCard label="Response time" value="1.5h" accent="yellow" />
      </div>
    </div>
  );
}
