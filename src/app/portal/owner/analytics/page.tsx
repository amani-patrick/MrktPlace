  ...
  return (
    <div>
      ...
      <div className="mb-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-4">
        <PortalStatCard label="Views this month" value="1,284" accent="green" />
        <PortalStatCard label="Favorites" value={47} accent="blue" />
        <PortalStatCard label="Shares" value={12} accent="yellow" />
        <PortalStatCard label="Contacts" value={36} accent="green" />
      </div>
